...
public class BottomBarTab extends LinearLayout {
  ...
  public void setBadgeHidesWhenActive(boolean hideWhenActive) {
    badgeHidesWhenActive = hideWhenActive;
  }
  ...
  public static class Config {
    ...
    private Config(Builder builder) {
      inActiveTabAlpha = builder.inActiveTabAlpha;
      activeTabAlpha = builder.activeTabAlpha;
      inActiveTabColor = builder.inActiveTabColor;
      activeTabColor = builder.activeTabColor;
      barColorWhenSelected = builder.barColorWhenSelected;
      badgeBackgroundColor = builder.badgeBackgroundColor;
      badgeHidesWhenSelected = builder.hidesBadgeWhenSelected;
      titleTextAppearance = builder.titleTextAppearance;
      titleTypeFace = builder.titleTypeFace;
    }
