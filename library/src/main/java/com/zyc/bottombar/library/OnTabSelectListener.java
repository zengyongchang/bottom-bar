...
public interface OnTabSelectListener {
  /**
   * The method being called when currently visible {@link com.zyc.android.bottombar.BottomBarTab} changes.
   *
   ...
   *
   * @param tabId the new visible {@link com.zyc.android.bottombar.BottomBarTab}
   */
